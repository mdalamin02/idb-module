...
<body>
	<div class="container mt-5">
		...
		<a href="addNew.php" class="btn btn-primary mb-2">Add New Products</a>
		<p></p>
		<table class="table table-bordered table-hover">
			...
			<?php
				...
				<tr>
					...
					<td>
						<a href="edit_product.php ?id=<?php echo $encrypted_id; ?>" class="btn btn-sm btn-warning">Edit</a>
					</td>

					<td>
						<a href="products.php ?delete_id=<?php echo $encrypted_id; ?>" class="btn btn-sm btn-danger">Delete</a>
					</td>
