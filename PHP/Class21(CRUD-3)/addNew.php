...
if(isset($_POST['btnsave']))
{
	...
	if(empty($errmsg))
	{
		$stmt = $DB_con->prepare("INSERT INTO products (product_name, description, product_image,unit_price, selling_price, stock_amount, has_attributes, category_id) VALUES (:pname, :pdesc,:ppic,:uprice, :sprice, :pstock,:hasattr,:cat_id)");
